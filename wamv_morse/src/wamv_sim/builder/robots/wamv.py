...
from wamv_sim.builder.sensors import Dvl
...
class Wamv(GroundRobot):
    ...
    def __init__(self, name = None, debug = True):
        ...
        GroundRobot.__init__(self, 'wamv_sim/robots/wamv_with_load.blend',name,blender_object_name='platform_boundary')
        self.properties(classpath = "wamv_sim.robots.wamv.Wamv")
        ...
        self.thrusters.add_stream('moos','wamv_sim.actuators.fixedThrustersCtrl.ThrustReader')
        ...
        self.pose.alter('','wamv_sim.sensors.PoseMod.PoseModifier')
        self.pose.add_stream('moos')

        self.imu = IMU()
        self.append(self.imu)
        self.imu.alter('','wamv_sim.sensors.IMUMod.IMUModifier')
        self.imu.add_stream('moos')

        self.DVL = Dvl()
        self.append(self.DVL)
        self.DVL.add_stream('moos','wamv_sim.sensors.DVLCtrl.DVLNotifier')
